...
class UtilisateurCreate(UtilisateurBase):
    ...
    def validator_mot_de_passe(cls, v: str):
        ...
        if not any(char in caracteres_speciaux for char in v):
            raise ValueError(f"Le mot de passe doit contenir au moins un caractère spécial parmi : {caracteres_speciaux} !")
        return v
...
# ==========================================
# SCHÉMAS POUR LE WIZARD (SAISIE TERRAIN)
# ==========================================
...
# ==========================================
# SCHÉMAS POUR LES ÉCHANTILLONS (FT06b)
# ==========================================
...
# SCHÉMAS POUR TENEUR EN EAU (FT32)
# ==========================================
class TeneurEauCreate(BaseModel):
    identifiant: Optional[str] = None
    coteTete: Optional[float] = None
    cotePied: Optional[float] = None
    humide105: Optional[float] = None
    humide150: Optional[float] = None
    sec105: Optional[float] = None
    sec150: Optional[float] = None

...
**ForaTrack** est une application web et tablette conçue pour numériser et simplifier le suivi géotechnique et géologique des forages réalisés en milieu souterrain (notamment pour le laboratoire de Bure).
...
* **Génération de Livrables :** Création automatique de rapports professionnels au format PDF et d'exports Excel/Word.
...
* **Base de Données :** [PostgreSQL](https://www.postgresql.org/) – Choix de clés primaires en **UUID** (via l'
